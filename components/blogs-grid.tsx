...
const filters = ['All', 'Web development', 'Full-Stack', 'Design'];
...
export default function BlogsGrid() {
  ...
  return (
    <section className="py-12 px-5 md:px-16 lg:px-32 bg-white">
      <div className="">
        <div className="mb-6">
          <h2 className="text-3xl font-bold mb-2">All <span className="text-teal-500">Articles</span></h2>
          <p className="text-gray-600 text-sm mb-6">A collection of projects showcasing my expertise across web development, design, and full-stack applications.</p>
